...
#SBATCH --mem=100G
#SBATCH --job-name="isd-2016-asv-pema"
...
#singularity run -B /home1/s.paragkamian/isd-crete/pema_test_asv/:/mnt/analysis /mnt/big/containers/singularity/pema_v.2.1.4.sif
